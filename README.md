# Введение в разработку для колесных робототв
...
Вам нужно выполнить [отборочное задание](https://github.com/warmhammer/iceberg_robotics_onboaring/tree/main/test_assignment) и отправить свой результат в форму сдачи домашек.
